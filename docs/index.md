...
- [Architecture Overview](architecture.md) — System design, layer architecture, key design decisions
...
- **Interactive API Docs**: `http://<host>:<port>/docs` (Swagger UI)
- **Alternative API Docs**: `http://<host>:<port>/redoc` (ReDoc)
- **Health Check**: `http://<host>:<port>/health`
- **GitHub Pages**: [https://gicsei.github.io/BAB/](https://gicsei.github.io/BAB/)
